 ...
 */
package com.woodcomputing.jefreader;
 ...
 */
@Log4j2
public class JEFReader extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
      ...
      bg.setStyle("-fx-background-color: #AAAAAA");
      Canvas canvas = new Canvas(width, height);
      canvas.scaleXProperty().set(.5);
      canvas.scaleYProperty().set(.5);
      bg.getChildren().add(canvas);
